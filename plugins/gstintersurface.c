...
GswInterSurface *
gsw_inter_surface_get (const char *name)
{
  GList *g;
  ...
  surface = g_malloc0 (sizeof (GswInterSurface));
  surface->ref_count = 1;
...
void
gsw_inter_surface_unref (GswInterSurface * surface)
{
